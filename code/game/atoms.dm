/atom
	...
	var/list/external_overlays	//overlays that comes from external sources and shouldn't normally be removed when using cut_overlay functions, like c4.
...
/atom/Destroy()
	...
	LAZYCLEARLIST(external_overlays)
